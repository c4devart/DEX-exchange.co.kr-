...
(function ($, undefined) {
	...
	var pluginPrototype = {
		...
		_init: function (options) {
			...
			}).wrapInner("<span class='tablesort-label' />").append("<span class='tablesort-arrows'><div><span class='tablesort-sortdesc' style='font-size:8px;margin-top:5px;'>&#9650;</span><span class='tablesort-sortasc' style='font-size:8px;margin-top:5px;'>&#9660;</span></div></span>").wrapInner("<div class='tablesort-th' />").on("click.tablesort", function (e) {
				var $this = $(this);
